...
public class MainAdapter extends BaseAdapter {
	...
	private List<AddPatientViewModel.PartandPatientEntity> list;
	private int position = 0;
	private Holder hold;

	public MainAdapter(Context context, List<AddPatientViewModel.PartandPatientEntity> list) {
	...
	public View getView(int arg0, View view, ViewGroup viewGroup) {
		...
		hold.txt.setText(list.get(arg0).getPartname());
