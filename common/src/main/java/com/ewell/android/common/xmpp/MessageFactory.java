...
private static final String tag_weekreport="<WeekSleep";
    ...
    private static final String tag_beduserinfo="<EPBedUserList";
    private static final String tag_maininfolist = "<MainInfo";
    ...
    public static BaseMessage GetMessage(String subjectXml, String bodyXml) throws EwellException {
        try {
            ...
            else if(bodyXml.indexOf(tag_maininfolist) == 0){
                return MainInfo.XmlToMessage(subjectXml, bodyXml);
            }
